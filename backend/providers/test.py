...
from baseapp.models import Plan, Coverage
    ...
    try:
        ...
        for i in range(len(panel_groups)):
            ...
            for j in panel:
                ...
                print(houses)
                for i in houses: 
                    match = re.findall(r'[А-Яа-я]+[А-Яа-я]+[А-Яа-я]+', )
                    if len(match) > 2:
                        print('Yes')
                    else:
                        print('No!')
...
#     try: 
#         for i in array:
#             new = Coverage(district=i['district'], street=i['street'], houses=[])
#             for j in i['houses']:
#                 new.houses.append(j)
#             new.save()
#             print('success')
